...
#             break
#         if opt == 5:
#             print("Eu só fiz esses menus pra passar tempo (e sei que existem formas mais fáceis de executar isso), se quiser desativar nos arquivos fica avontade pra testar de outras maneiras! Só basta comentar a seção dos menus e retirar o comentário da forma direta de utilizar...")
#             break
#         if opt == 6:
#             break
#         else:
